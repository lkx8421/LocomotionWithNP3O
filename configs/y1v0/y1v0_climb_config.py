...
class Y1V0ClimbCfg( LeggedRobotCfg ):
...
class Y1V0ClimbCfg_Play( Y1V0ClimbCfg ):
    class env(Y1V0ClimbCfg.env):
        num_envs = 10
    class terrain(Y1V0ClimbCfg.terrain):
        mesh_type = 'trimesh'  # "heightfield" # none, plane, heightfield or trimesh
        num_rows = 5
        num_cols = 5
    ...
    class noise( Y1V0ClimbCfg.noise ):
        add_noise = False
    class control ( Y1V0ClimbCfg.control ):
        use_filter = True
    class domain_rand( Y1V0ClimbCfg.domain_rand ):
        push_robots = False
